...
const damageFields = [
  {
    ...
    type: "dropdown",
    options: [
      { label: "Çarpışma", value: "carpisma" },
      { label: "Çarpma", value: "carpma" },
      { label: "Park Hali", value: "park_hali" },
      { label: "Sabit Cisme Çarpma", value: "sabit_cisme_carpma" },
    ],
    required: true,
...

  {
    ...
    type: "dropdown",
    options: [
      { label: "İfade Tutanağı", value: "ifade_tutanagi" },
      { label: "Anlaşmalı Tutanak", value: "anlasmali_tutanak" },
