...
const driverFields = [
  ...
  {name: "foreign_driver_tc", label:"Yabancı Kimlik No", placeholder:"11 Hane", type: "tckn", required: true, maxLength:11},
  { name: "driver_phone", label: "Telefon", placeholder: "5xxxxxxxxx", type: "phone", required: true },
  { name: "driver_birth_date", label: "Doğum Tarihi", placeholder: "DD.MM.YYYY", type: "date", required: false },
];
