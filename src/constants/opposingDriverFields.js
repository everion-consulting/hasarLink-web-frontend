const opposingDriverFields = [
  ...
  { name: "opposing_foreign_driver_tc", label: "Yabancı Kimlik No", placeholder: "11 hane", type: "tckn", required: true, maxLength: 11 },
  { name: "opposing_driver_phone", label: "Telefon", placeholder: "5xxxxxxxxx", type: "phone", required: true },
  { name: "opposing_driver_birth_date", label: "Doğum Tarihi", placeholder: "DD.MM.YYYY", type: "date", required: false },
];
